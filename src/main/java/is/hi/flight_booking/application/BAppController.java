...
public class BAppController implements Initializable {
    ...
    private final String[] destinations = {"Akureyri","Egilsstaðir","Ísafjörður","Keflavík","Reykjavík","Vestmannaeyjar"};
    ...
    public void fxSearchButton(ActionEvent actionEvent) {
        if (getFxBothWays()){
            if(fxFromDest.getValue() == null || fxToDest.getValue() == null
                ...
                // Hér á auðvitað að eftir að græja það sem gerist þegar leitarskilyrði eru uppfyllt

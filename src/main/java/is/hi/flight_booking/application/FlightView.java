...
public class FlightView extends HBox {
    // Hér er auðvitað pínu furðulegt í samhengi við það að maður á að geta sorterað eftir tíma
    ...
    public FlightView(Flight flight, boolean isRetFlight) {
        ...
        fxListedFlightTotalSeats.setText(Integer.toString(storedFlight.getNumSeatsAvailable()+storedFlight.getNumSeatsReserved()));
    ...
    // Hér á eftir að bæta við virkni. Þ.e.a.s hvað gerist þegar það er smellt á FlightView.
}
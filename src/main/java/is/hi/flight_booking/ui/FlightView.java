...
public class FlightView extends HBox {
  ...
  public FlightView(Flight flight, boolean isRetFlight,
    ...
    if (!getIsOneWay() && isReturnFlight() && SFBWC.getSelectedReturnFlight() != null) {
      if (this.getStoredFlight().getFlightId()
          .equals(SFBWC.getSelectedReturnFlight().getStoredFlight().getFlightId())) {
      ...
      if (this.getStoredFlight().getFlightId()
          .equals(SFBWC.getSelectedDepartureFlight().getStoredFlight().getFlightId())) {
        this.setSelected(true);
        setSelectedBG(this);
      ...
      if (this.isReturnFlight()) {
        if (this.isSelected()) {
          ...
          if (oldReturnFV != null) {
            ...
            SFBWC.setSelectedReturnFlight(this);
            System.out
                .println("Stored return fligth id: " + SFBWC.getSelectedReturnFlight().getStoredFlight().getFlightId());
            e.consume();
          } else {
            this.setSelected(true);
            setSelectedBG(this);
        ...
        if (this.isSelected()) {
          ...
          if (oldDepartureFV != null) {
            ...
            SFBWC.setSelectedDepartureFlight(this);
            System.out.println(
                "Stored departure fligth id: " + SFBWC.getSelectedDepartureFlight().getStoredFlight().getFlightId());
            e.consume();
          } else {
            this.setSelected(true);
            setSelectedBG(this);
